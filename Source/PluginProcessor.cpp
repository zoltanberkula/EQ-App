...
//    osc.prepare(spec);
//    osc.setFrequency(8000); //adjust the frequency according to your needs
...
bool SimpleEQAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
    ...
    // In this  ate code we only support mono or stereo.
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& apvts){
    ...
    /*OSCILLATOR BEGIN*/
    settings.oscFreq = apvts.getRawParameterValue("OSC Freq")->load();
    /*OSCILLATOR END*/
...
void SimpleEQAudioProcessor::updateOscillator(const ChainSettings& chainSettings){
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    /*OSCILLATOR BEGIN*/
    layout.add(std::make_unique<juce::AudioParameterFloat>("OSC Freq", "OSC Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 1.f));
    /*OSCILLATOR END*/
