...
struct ChainSettings
{
    ...
    float lowCutFreq {0}, highCutFreq {0}, oscFreq {0};
...
inline auto makeOscillator(const ChainSettings& chainSettings, double sampleRate)
{
...
private:
    ...
    void updateOscillator(const ChainSettings& chainSettings);
    void updateFilters();
